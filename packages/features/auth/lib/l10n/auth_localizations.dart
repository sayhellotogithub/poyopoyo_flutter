...
abstract class AuthLocalizations {
  ...
  /// No description provided for @auth_token_expired.
  ///
  /// In en, this message translates to:
  /// **'Your session has expired. Please sign in again.'**
  String get auth_token_expired;

  /// No description provided for @auth_kyc_required.
  ///
  /// In en, this message translates to:
  /// **'Please complete identity verification (KYC).'**
  String get auth_kyc_required;

  /// No description provided for @auth_user_blocked.
  ///
  /// In en, this message translates to:
  /// **'Your account is suspended for {days} day(s).'**
